...
import type { TeacherFormData, FormErrors } from '../../../shared/types/forms.types';
    ...
    <div className="space-y-2.5">
      ...
      <div>
        <Input
          ...
          className=""
        />
        <p className="mt-0.5 text-xs text-gray-500 dark:text-slate-400">Separate multiple subjects with commas</p>
      </div>
    </div>
  );
};
